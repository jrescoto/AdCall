...
class SluggableBehavior extends ModelBehavior
{
	...
	{
        //debug(Inflector::camelize($model->primaryKey));
        //debug($settings);
	...
	private function _record_needs_slug(&$model)
	{
		...
		if (!($model->id)) {
            ...
            // assigned findBy<camelized(primaryKey)> value to $findBy to make the query dynamic
            $findBy = 'findBy' . Inflector::camelize($model->primaryKey);
			$existing_data = $model->$findBy($model->id);
